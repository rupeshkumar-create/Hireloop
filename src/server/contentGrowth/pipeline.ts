...
export function getCronSchedule() {
  return [
    {
      id: 'tick',
      name: 'All scheduled tasks (use this on cron-job.org)',
      path: '/api/cron/tick',
      schedule: '0 8 * * *',
      utcTime: '08:00 UTC daily',
      description: 'Runs daily-alerts, daily-blog, and weekly/monthly jobs when due',
      aiCalls: 0,
    },
    {
      id: 'daily-blog',
      ...
      schedule: '5 8 * * *',
      utcTime: '08:00 UTC daily (via tick)',
    ...
    },
    {
      ...
      schedule: '10 8 * * 6',
      utcTime: '08:00 UTC every Saturday (via tick)',
    ...
    },
    {
      ...
      schedule: '15 8 1 * *',
      utcTime: '08:00 UTC on the 1st (via tick)',
