  ...
  return (
    <div className="mx-auto max-w-4xl py-12 md:py-16">
      <div className="markdown-body max-w-none rounded-xl border border-border bg-surface p-8 md:p-12">
        ...
        <p>By accessing and using Hireloop ("the Service"), you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.</p>

        <h2>2. Description of Service</h2>
        <p>Hireloop provides an AI-powered recruiting agent that analyzes user resumes, searches the internet for relevant job postings, generates personalized cold emails, and tracks job applications. The Service is available via a free tier and a paid subscription tier.</p>
        ...
        <p>The Service and its original content, features, and functionality are and will remain the exclusive property of Hireloop and its licensors. The Service is protected by copyright, trademark, and other laws.</p>
        ...
        <p>Hireloop does not guarantee that you will receive job offers, interviews, or employment as a result of using our Service.</p>

        <h2>7. Limitation of Liability</h2>
        <p>In no event shall Hireloop, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your access to or use of or inability to access or use the Service.</p>
