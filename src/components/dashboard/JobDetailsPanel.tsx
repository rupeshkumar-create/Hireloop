                ...
                {aiAction === 'email' && (
                  <div className="mt-6 border-t border-zinc-200 pt-4 space-y-4">
                    <Button 
                      className="w-full" 
                      onClick={async () => {
                        // First tailor the resume before opening Gmail
                        ...
                        // Create a markdown file from the optimized resume
                        const blob = new Blob([optimizedResume], { type: 'text/markdown' });
                        const url = URL.createObjectURL(blob);
                        
                        // Download the file automatically so they can attach it
                        ...
                        // Open Gmail with the cold email draft
                    ...
                    >
                      <Mail className="mr-2 h-4 w-4" /> Open in Gmail with Tailored Resume
                    </Button>
