...
import { Bookmark, BookmarkCheck, Calendar, Loader2 } from 'lucide-react';
...
export function DailyMatchHistoryTab({ days, loading, totals }: DailyMatchHistoryTabProps) {
            ...
            {day.jobs.map((job) => {
              ...
              return (
                <article
                  ...
                  className="hs-card-row cursor-default"
                >
